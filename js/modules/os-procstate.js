 ...
 * 考情：18 年中 10 年（2010-26、2012-30、2014-26、2015-25、2017-27、2018-27、
 * 2019-24、2021-27、2022-28、2023-27），全为选择题；辨析"谁触发 + 去哪个队列"。
 * （窗11 theory 体检时删掉原注释里的"2025-25 调度时机"——该题回 `考情缓存/` 查不到。）
...
RC408.registerModule({
  ...
  theory: `
> **为什么要有它**：进程要等 I/O、等 CPU，不可能一直占着处理机——必须用状态描述"它此刻在等什么"。
> **怎么实现**：五态模型 + 一张"谁能把它推到哪"的迁移表（每次迁移都有明确的触发事件）。
> **记住什么**：分清**谁触发**（调度程序 / 进程自身 / 中断）与**去哪个队列**，并记住三条不存在的迁移。
...
> **真题考情**：**10/18 年**，全为选择题（2010-26、2012-30、2014-26、2015-25、2017-27、2018-27、
> 2019-24、2021-27、2022-28、2023-27）——每年就是"下列迁移哪个不可能发生"这一问。
`,
