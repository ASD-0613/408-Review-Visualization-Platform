...
RC408.registerModule({
  ...
  theory: `
> **真题考情**：18 年中 7 年考（2009-25、2011-27、2012-27、2013-32、2018-26、2020-27、2022-26），
> 全为选择题，固定问法："该状态是否安全？若安全给出一个**安全序列**"。
...
## 考点提示
- 比较是**逐维**的：Need 每一维都要 ≤ Work 对应维；
- 安全序列可能**不止一个**，题目常问"下列哪个是/不是安全序列"；
- 银行家算法属于**死锁避免**（分配前判断），与死锁检测/预防区分（2023 真题）。
`,
