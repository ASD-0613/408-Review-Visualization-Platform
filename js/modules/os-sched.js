 ...
 * 考情：18 年中 13 年涉及（周转/等待时间计算是高频选择题；2016-46 大题动态优先数设计）。
...
RC408.registerModule({
  ...
  theory: `
> **真题考情**：18 年中 13 年涉及调度（2011-23 高响应比、2017-23 作业调度、2021-25 时间片轮转、
> 2022-25 抢占优先级、2023-29 平均周转时间、2024-30 RR 周转时间；2016-46 大题动态优先数）。

## 四种算法（本模块均为非抢占；RR 按时间片轮转）
| 算法 | 选取规则 | 特点 |
| --- | --- | --- |
...
## 指标公式（大题必背）
**周转时间 = 完成 − 到达**；**带权周转 = 周转 ÷ 运行**；**等待 = 周转 − 运行**；
平均周转 = Σ周转 ÷ 进程数。
`,
