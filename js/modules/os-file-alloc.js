...
RC408.registerModule({
  ...
  theory: `
> **真题考情**：近年大题常客（2010-30、2012-46、2013-26、2018-46、2022-45、2026-46），
...
## 考点提示
- 分母别搞混：地址项个数 N 由"块大小 ÷ 地址项长度"决定，与文件大小无关；
- 文件**增大**时先占满直接块 → 一级 → 二级（2022 真题：文件增至 6MB 用到哪级）；
- 题目若说"读 inode 需 1 次访盘"则总次数还要 +1（先读 inode 才知道地址）。
`,
